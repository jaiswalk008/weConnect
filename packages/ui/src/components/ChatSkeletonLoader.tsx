...
// Note: This component expects useMediaQuery to be provided by the consuming application
// If using in the weConnect client app, import useMediaQuery from '@/hooks/useMediaQuery'
// For now, using a simple media query check inline
  ...
  return (
    <div className="flex-1 flex flex-col h-full w-full bg-background">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border bg-card">
        {isMobile && <Skeleton className="w-5 h-5 rounded mr-2 flex-shrink-0" />}
