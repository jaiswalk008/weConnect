...
import { Label } from '@weconnect/ui';
import { Textarea } from '@weconnect/ui';
import { Checkbox } from '@weconnect/ui';
                  ...
                  {selectedFriendObjects.map((friend) => (
                    ...
                    >
                      <div className="relative">
                        <ProfileImage size="small" image={friend.profile_image} chatName={friend.name} />
                        <button
